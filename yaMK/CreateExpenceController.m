...
- (IBAction)createTransaction:(id)sender {
    ...
    Account *recipientAccount = [_accountFinder findAccount:[_recipientAccount stringValue] type:Expense];
...
- (NSArray *)expenseTransactionsSortDescriptors {
    return [NSArray arrayWithObject:[NSSortDescriptor sortDescriptorWithKey:@"name" ascending:YES]];
}

- (void) setExpenseTransactionsSortDescriptors:(NSArray *)ExpenseTransactionsSortDescriptors {
